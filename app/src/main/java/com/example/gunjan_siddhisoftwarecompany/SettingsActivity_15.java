...
public class SettingsActivity_15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // GENERAL
        setRow(R.id.rowLanguage,
                R.drawable.setting_15_1,
                "Language",
                "English");

        setRow(R.id.rowSubscription,
                R.drawable.setting_15_2,
                "Subscription",
                "");

        setRow(R.id.rowShortcut,
                R.drawable.setting_15_3,
                "Shortcut",
                "");

        setRow(R.id.rowHowTo,
                R.drawable.setting_15_4,
                "How to use?",
                "");

        // OTHER
        setRow(R.id.rowShare,
                R.drawable.setting_15_5,
                "Share App",
                "");

        setRow(R.id.rowRate,
                R.drawable.setting_15_6,
                "Rate App",
                "");
    }
